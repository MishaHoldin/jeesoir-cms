...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    images: Schema.Attribute.Component<'item-block.item-block', false>;
    itemBlock: Schema.Attribute.Component<'item-block.item-block', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    swiperItems: Schema.Attribute.Component<'swiper-items.swiper-items', false>;
    swiperItems2: Schema.Attribute.Component<
      'swiper-items.swiper-items',
      false
    >;
    swiperItems3: Schema.Attribute.Component<
      'swiper-items.swiper-items',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    same_product: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    same_products: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
    >;
    sizes: Schema.Attribute.Relation<'manyToMany', 'api::size.size'>;
    sizeTable: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiReturnReturn extends Struct.SingleTypeSchema {
